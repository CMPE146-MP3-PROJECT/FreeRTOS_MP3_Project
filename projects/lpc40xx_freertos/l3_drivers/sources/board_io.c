...
void board_io__initialize(void) {
  ...
  // Input pins
  board_io__sw3 = gpio__construct_as_input(GPIO__PORT_1, 19);
  board_io__sw2 = gpio__construct_as_input(GPIO__PORT_1, 15);
  board_io__sw1 = gpio__construct_as_input(GPIO__PORT_0, 30);
