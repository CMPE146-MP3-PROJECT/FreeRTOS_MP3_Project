...
void gpiox__set_as_output(int pin_num) { LPC_GPIO1->DIR |= (1 << pin_num); }

/// Should alter the hardware registers to set the pin as high
void gpiox__set_high(int pin_num) { LPC_GPIO2->SET = (1 << pin_num); }

/// Should alter the hardware registers to set the pin as low
void gpiox__set_low(int pin_num) { LPC_GPIO2->CLR = (1 << pin_num); }
