...
void gpiox__set_as_output(port_pin_s pin_num) { LPC_GPIO1->DIR |= (1 << pin_num.pin); }

/// Should alter the hardware registers to set the pin as high
void gpiox__set_high(port_pin_s pin_num) { LPC_GPIO2->SET = (1 << pin_num.pin); }

/// Should alter the hardware registers to set the pin as low
void gpiox__set_low(port_pin_s pin_num) { LPC_GPIO2->CLR = (1 << pin_num.pin); }
